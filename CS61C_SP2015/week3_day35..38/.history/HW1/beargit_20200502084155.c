...
int beargit_commit(const char *msg)
{
  ...
  // Create the .beargit/.newID directory.
  sprintf(commit_dir, ".beargit/%s", commit_id); // Maybe stream pointer?
  fs_mkdir(commit_dir);

  /** int fprintf(FILE * stream, const char *format, ...)
   *  Loads the data from the given locations, converts them 
   *  to character string equivalents and writes the results 
